...
data1 = np.genfromtxt('n30_j1000_runs240.dat')
data2 = np.genfromtxt('n30_j2000_runs240.dat')
# data3 = np.genfromtxt('n15_j1000_runs240_EPSILON0.85.dat')
...
plt.plot(x, y, label="data from review")
plt.xlabel("E")
plt.ylabel('p(E)')

plt.plot(x1, y1, label='j=1000')  # 10
plt.plot(x2, y2, label='j=2000')  # 15
# plt.plot(x3, y3, label='n=30')
# # plt.plot(x4, y4, label='25')  # 25
# plt.plot(x5, y5, label='30')  # 30
# # plt.plot(x6, y6, label='35')
# plt.plot(x7, y7, label='40')
